...
export default function Footer({ language = 'es', home = true }) {
  ...
  const technical = language === 'en'
    ? { guides: '/en/guides', guideLabel: 'Guides', route: '/en/abnormal-load-route-survey', routeLabel: 'Route surveys', permits: '/en/abnormal-load-permits', permitsLabel: 'Permits' }
    : { guides: '/guias', guideLabel: 'Centro técnico', route: '/estudio-ruta', routeLabel: 'Estudios de ruta', permits: '/gestion-permisos', permitsLabel: 'Permisos' };
  return (
